...
** Vertico
[[https://github.com/minad/vertico][Vertico]] is a minimalistic vertical completion UI. I chose this one over other alternatives
because it seems to be simple (~600 LOC)

Also the author (ie. Daniel Mendler) seems to a highly known package developer (and really serious one)
